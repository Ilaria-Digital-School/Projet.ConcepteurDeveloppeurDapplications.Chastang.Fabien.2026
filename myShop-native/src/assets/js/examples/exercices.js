...
// let description = [
//         {
//           "title": "Restez à l’aise même sous la chaleur",
//           "description": [
//             "Conçue pour les journées ensoleillées, cette Chemise d’Été allie légèreté et respirabilité pour apporter une sensation de confort agréable lors de vos sorties.",
//             "Sa matière favorise une bonne circulation de l’air, aide à réguler l’humidité et rend le port plus agréable.",
//             "Profitez pleinement de l’été en restant à votre aise."
//           ]
//         },
//         {
//           "title": "Un style naturel, chic avec simplicité",
//           "description": [
//             "Avec sa coupe ajustée et sa belle fluidité, cette chemise offre une allure élégante et décontractée. Inutile d'en faire trop, elle s'adapte facilement à toutes vos tenues.",
//             "Portée ouverte ou fermée, avec un short ou un pantalon, elle conserve un style sobre et raffiné."
//           ]
//         },
//         {
//           "title": "Entretien facile pour un été sans tracas",
//           "description": [
//             "Cette Chemise est conçue pour vous simplifier la vie : elle passe en machine et sèche simplement à l'air libre.",
//             "Même légèrement froissée, elle garde son charme naturel. Son tissu offre une sensation de douceur et de confort agréable à chaque port.",
//             "Son confort et sa douceur en font une pièce appropriée pour vous accompagner durant l'été."
//           ]
//         }
//       ];

// document.getElementById("TEST").textContent = JSON.stringify(JSON.stringify(description));

// "[{\"title\":\"Restez à l’aise même sous la chaleur\",\"description\":[\"Conçue pour les journées ensoleillées, cette Chemise d’Été allie légèreté et respirabilité pour apporter une sensation de confort agréable lors de vos sorties.\",\"Sa matière favorise une bonne circulation de l’air, aide à réguler l’humidité et rend le port plus agréable.\",\"Profitez pleinement de l’été en restant à votre aise.\"]},{\"title\":\"Un style naturel, chic avec simplicité\",\"description\":[\"Avec sa coupe ajustée et sa belle fluidité, cette chemise offre une allure élégante et décontractée. Inutile d'en faire trop, elle s'adapte facilement à toutes vos tenues.\",\"Portée ouverte ou fermée, avec un short ou un pantalon, elle conserve un style sobre et raffiné.\"]},{\"title\":\"Entretien facile pour un été sans tracas\",\"description\":[\"Cette Chemise est conçue pour vous simplifier la vie : elle passe en machine et sèche simplement à l'air libre.\",\"Même légèrement froissée, elle garde son charme naturel. Son tissu offre une sensation de douceur et de confort agréable à chaque port.\",\"Son confort et sa douceur en font une pièce appropriée pour vous accompagner durant l'été.\"]}]"

// let str = "[{\"title\":\"Restez à l’aise même sous la chaleur\",\"description\":[\"Conçue pour les journées ensoleillées, cette Chemise d’Été allie légèreté et respirabilité pour apporter une sensation de confort agréable lors de vos sorties.\",\"Sa matière favorise une bonne circulation de l’air, aide à réguler l’humidité et rend le port plus agréable.\",\"Profitez pleinement de l’été en restant à votre aise.\"]},{\"title\":\"Un style naturel, chic avec simplicité\",\"description\":[\"Avec sa coupe ajustée et sa belle fluidité, cette chemise offre une allure élégante et décontractée. Inutile d'en faire trop, elle s'adapte facilement à toutes vos tenues.\",\"Portée ouverte ou fermée, avec un short ou un pantalon, elle conserve un style sobre et raffiné.\"]},{\"title\":\"Entretien facile pour un été sans tracas\",\"description\":[\"Cette Chemise est conçue pour vous simplifier la vie : elle passe en machine et sèche simplement à l'air libre.\",\"Même légèrement froissée, elle garde son charme naturel. Son tissu offre une sensation de douceur et de confort agréable à chaque port.\",\"Son confort et sa douceur en font une pièce appropriée pour vous accompagner durant l'été.\"]}]";
// document.getElementById("TEST").textContent = Array.isArray(JSON.parse(str));
