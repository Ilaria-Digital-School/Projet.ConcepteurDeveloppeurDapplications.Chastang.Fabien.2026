...
export const validateAddStatus = (req, res, next) => {
  const Schema = Joi.object({
    value: Joi.number().valid(0, 1, 2, 3, 4, 5, 6).required().messages({
...
export const validateUpdStatus = (req, res, next) => {
  const Schema = Joi.object({
    value: Joi.number().valid(0, 1, 2, 3, 4, 5, 6).optional().messages({
