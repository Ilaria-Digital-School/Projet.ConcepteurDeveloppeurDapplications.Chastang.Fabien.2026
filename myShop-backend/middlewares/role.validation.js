...
export const validateAddRole = (req, res, next) => {
  const Schema = Joi.object({
    value: Joi.number().valid(0, 1, 2).required().messages({
...
export const validateUpdRole = (req, res, next) => {
  const Schema = Joi.object({
    value: Joi.number().valid(0, 1, 2).optional().messages({
